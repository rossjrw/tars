...
badd +25 bot.py
badd +17 bot.conf
badd +49 plugins/nickserv.py
badd +0 plugins/parse.py
badd +72 ~/.vimrc
badd +0 plugins/debug.py
badd +0 plugins/parsemessages.py
badd +0 plugins/__init__.py
argglobal
silent! argdel *
argadd bot.py
set stal=2
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 25 - ((16 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
25
...
52
normal! 034|
tabedit plugins/parsemessages.py
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 22 + 53) / 106)
exe '2resize ' . ((&lines * 24 + 26) / 52)
exe 'vert 2resize ' . ((&columns * 83 + 53) / 106)
exe '3resize ' . ((&lines * 24 + 26) / 52)
exe 'vert 3resize ' . ((&columns * 83 + 53) / 106)
argglobal
enew
file NERD_tree_8
let s:cpo_save=&cpo
...
17
normal! zo
let s:l = 21 - ((17 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
21
...
11
normal! zo
let s:l = 19 - ((0 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
19
...
24
normal! zo
let s:l = 70 - ((48 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
70
